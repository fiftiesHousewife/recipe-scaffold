...
RECIPE_DESCRIPTION="OpenRewrite recipes scaffolded from recipe-scaffold"
GITHUB_ORG="acme"
...
# Drop a .recipe-scaffold.yml so a subsequent `recipe-scaffold add-recipe` knows
# the project's identity. Mirrors what jbang/RecipeScaffold.java's Init writes.
cat > "$OUT/.recipe-scaffold.yml" <<EOF
